"""
File containing all functionality related to the SVM model.
"""
...
class SVM(Model):
    """
    Class to implement functionality for the SVM model.
    """
    def __init__(self, dataset, params):
        """
        Constructor for the SVM model.
        :param dataset: Dataset instance containing the whole dataset to run SVM on.
        :param params: dictionary determining the parameters of the SVM model.
        """
    ...
    def tune(self, param_space, n_jobs=1, verbose=False):
        ...
        self.__model = SVM(self.__dataset, tuned_params)
        return tuned_params
