"""
File containing all functionality related to the XGBoost model.
"""
...
class XGBoost(Model):
    """
    Class to implement functionality for the XGBoost model.
    """
    def __init__(self, dataset, params):
        """
        Constructor for the XGBoost model.
        :param dataset: Dataset instance containing the whole dataset to run XGBoost on.
        :param params: dictionary determining the parameters of the XGBoost model.
        """
    ...
    def fit(self, x_train=None, y_train=None, x_val=None, y_val=None, use_val=False):
        """
        Fits the XGBoost to a (specified) dataset.
